...
-----
    ...
    python src/extraction/ercot_wpp_archive.py --trial-only
    python src/extraction/ercot_wpp_archive.py --auto
    python src/extraction/ercot_wpp_archive.py --from 2021-01-01 --to 2023-11-30 --auto

Outputs
-------
Trial (CSV)   : data/raw/ercot/wpp_archive_trial.csv
Full (Parquet): data/raw/ercot/wpp_archive_YYYYMMDD_YYYYMMDD.parquet
"""
...
# Override OUT_DIR so output lands in data/ next to this script on the cluster,
# not in the project-level data/raw/ercot/ path that ercot_common defines.
